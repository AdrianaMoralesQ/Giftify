...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { album_name: @music.album_name, album_type: @music.album_type, description: @music.description, year: @music.year } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { album_name: @music.album_name, album_type: @music.album_type, description: @music.description, year: @music.year } }
